...
test("adding multiple valid cars to database", async () => {
    const testCar: Car = {model: "Honda Civic", year: 2006, mileage: 2, dateBought: new Date(), url: "https://img.sm360.ca/ir/w640/images/newcar/ca/2025/honda/civic-berline-hybride/sport/sedan/2025_honda_civic-sedan-hybride_sport_photos_002.jpg", userID: "sef"}
    const testCar2: Car = {model: "Ford F-150", year: 2004,  mileage: 2, dateBought: new Date(), url: "https://img.sm360.ca/ir/w640/images/newcar/ca/2025/honda/civic-berline-hybride/sport/sedan/2025_honda_civic-sedan-hybride_sport_photos_002.jpg", userID: "sef"}
...
test("updating car with valid args", async () => {
    const testCar: Car = {model: "Honda Civic", year: 2006, mileage: 1, dateBought: new Date(), url: "https://img.sm360.ca/ir/w640/images/newcar/ca/2025/honda/civic-berline-hybride/sport/sedan/2025_honda_civic-sedan-hybride_sport_photos_002.jpg", userID: "sef"}
